...
public class InspirationConstants {
	...
	public static final double	SKIP_RATE_DEFAULT	= 0.25;
	public static final double	SKIP_RATE_HIGH		= 0.85;
	public static final double	SKIP_RATE_MEDIUM	= 0.50;
	public static final double	SKIP_RATE_LOW		= 0.15;
